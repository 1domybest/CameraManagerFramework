...
//
// xcrun -sdk iphoneos metal -std=ios-metal2.1 -mios-version-min=13.0 CameraMetalShader.metal -c -o CameraMetalShader.air
// xcrun -sdk iphoneos metallib CameraMetalShader.air -o CameraMetalShader.metallib
...
fragment float4 fragmentShader(VertexOut in [[stage_in]],
    ...
    return texture.sample(textureSampler, in.texCoord.xy);
}
